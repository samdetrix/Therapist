            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Edit a Client</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="index.html">Dashboards</a></li>
                                    <li class="breadcrumb-item active">Edit a Client</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('clients.update', ['client' => $client])}}" class="needs-validation"
                                    ...
                                    <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        name="name" value="{{$client->client_name}}" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="mb-4 form-group">
                                                                    ...
                                                                    <select class="form-control" id="gender"
                                                                        name="gender" value="{{$client->gender}}" required>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="mb-4">
                                                                    <label for="basicpill-firstname-input">ID Number <strong
                                                                            class="text-danger">*</strong></label>
                                                                    <input type="text" class="form-control"
                                                                        id="" name="id_number" value="{{$client->identification_number}}"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control" id=""
                                                                ...
                                                                name="next_of_kin_name" value="{{$client->next_of_kin_name}}" required>
                                                        </div>
                                                        <div class="mb-4">
                                                            <label class="text-capitalize"
                                                                for="basicpill-firstname-input">Phone Number<strong
                                                                    class="text-danger">*</strong></label>
                                                            <input type="text" value="{{$client->next_of_kin_number}}" class="form-control mb-110px"
                                                                id=""
                                        ...
                                        <div class="col-12  text-end" style="margin-top:20px;">
                                            <input
                                                ...
                                                type="submit" value="Edit Client Details">
                                        </div>
                                    </div>
                                </form>
                            </div>
