...
<head>
    ...
    <meta charset="utf-8" />
    <title>Psychiatric Clinic</title>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{route('therapist.appointments')}}" class="waves-effect">
                                <i class="mdi mdi-shield-home"></i><span>Appointments</span>
                            </a>
                        </li>
