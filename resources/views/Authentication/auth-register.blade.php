                        ...
                        <div class="w-100 ">
                            ...
                            <div class="d-flex flex-column h-100 ">
                                ...
                                <div class="my-auto ">
                                    ...
                                    <div>
                                        <h5 class="text-primary ">Administrator Sign Up !</h5>
                                    </div>
                                        ...
                                        <form action="{{ route('register.user') }}" class="needs-validation" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select id="landlord-type" name="role" class="form-select d-none" required>
                                            ...
                                            <div class="mt-3 d-grid ">
                                                    ...
                                                    <input class="btn btn-primary waves-effect waves-light" type="submit" value="Sign Up">
                                            </div>
                                            <div class="mt-3 d-grid " style="text-align: center;">
                                                <span style="font-size: 12px;">Already have an account? <a
                                                        href="{{route('login.page')}}"
                                                        style="color: #556ee6; text-decoration: none;">Login</a></span>
                                            </div>
                                        </form>
                                    </div>
                                </div>
